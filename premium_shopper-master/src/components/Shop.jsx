              ...
              <div className=" d-flex flex-column">
                ...
                <div className="row tw-mb-12">
                  <div className=" tw-flex tw-flex-wrap tw-gap-4">
                    <div className=" d-flex tw-mb-3 tw-justify-center tw-items-center tw-px-2 tw-py-1 tw-bg-gray-100 ">
                    ...
                    <div className=" d-flex tw-mb-3 justify-content-center align-items-center tw-p-4 tw-bg-gray-100 ">
                      <h2 className=" tw-me-4 tw-text-base tw-text-gray-500">
                        Summer
                      </h2>
                      <span className="">
                    ...
                    <div className="tw-mb-3 d-flex justify-content-center align-items-center tw-p-4 tw-bg-gray-100 ">
                      <h2 className=" tw-me-4 tw-text-base tw-text-gray-500">
                        White
                      </h2>
                      <span className="">
                  ...
                  <div className="row">
                    <div className="col-6 col-md-4 col-lg-3">
                      <div className="sh-card mb-7">
                        <div className=" card-badge sh-badge bg-white text-uppercase text-black px-2">
                          New
                        </div>
                        <div className=" sh-card-img position-relative">
                          <a href="#" className=" sh-card-img-hover d-block">
                            <img
                              src={back1}
                              className=" card-img-top img-back "
                              alt=""
                            />
                            <img
                              src={front1}
                              className=" card-img-top img-front"
                              alt=""
                            />
                    ...
                    <div className="col-6 col-md-4 col-lg-3">
                      <div className="sh-card mb-7">
                        <div className=" card-badge sh-badge bg-black text-white text-uppercase px-2">
                          New
                        </div>
                        <div className=" sh-card-img position-relative">
                          <a href="#" className=" sh-card-img-hover d-block">
                            ...
                            <div className=" sh-card-actions gap-2">
                              <span className=" sh-card-action">
                                <button
                                  className=" btn-circle sh-btn-xs sh-btn-white-primary"
                                  type="button"
                                  data-bs-toggle="modal"
                                  data-bs-target="#exampleModal"
                                >
                              ...
                              <span className=" sh-card-action">
                                <button className=" btn-circle sh-btn-xs sh-btn-white-primary">
                                  <LuShoppingCart className=" text-black-50" />
                                </button>
                              </span>
                              <span className=" sh-card-action">
                                <button className=" btn-circle sh-btn-xs sh-btn-white-primary">
                                  <AiOutlineHeart className=" text-black-50" />
                                </button>
                              </span>
                            </div>
                          </a>
                    ...
                    <div className="col-6 col-md-4 col-lg-3">
                      <div className="sh-card mb-7">
                        <div className=" card-badge sh-badge bg-white text-uppercase px-2 text-black">
                          New
                        </div>
                        <div className=" sh-card-img position-relative">
                          <a href="#" className=" sh-card-img-hover d-block">
